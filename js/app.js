...
const megaroster = {
    ...
    addStudent(ev) {
        ...
        this.students.unshift(student) //adds the new student values into the students array at the start of the array
        ...
        this.prependChild(this.studentList, listItem) // adds elements to the top of the list
        this.max++
        f.reset() //clears field or f.studentName.value = ""
    },

    prependChild(parent,child){//function for adding child to the top
